      ...
      >
        ...
        <ul className="sub-menu">
          <li>
            <Link
              to="/"
              className={activeMenu === "/home-1" ? "active-menu" : ""}
            >
              Home Page One
            </Link>
          </li>
          <li>
            <Link
              to="/home-2"
              className={activeMenu === "/home-2" ? "active-menu" : ""}
            >
              Home Page Two
            </Link>
          </li>
          <li>
            <Link
              to="/home-3"
              className={activeMenu === "/home-3" ? "active-menu" : ""}
            >
              Home Page Three
            </Link>
          </li>
      ...
      >
        ...
        <ul className="sub-menu">
          ...
          >
            ...
            <ul className="sub-menu right ">
              ...
              <li>
                <Link
                  to="/team/team-2"
                  className={activeMenu === "/team-2" ? "active-menu" : ""}
                >
                  Our Team 2
                </Link>
              </li>
              <li>
                <Link
                  ...
                  className={
                    activeMenu === "/team-details" ? "active-menu" : ""
                  }
                >
                  Team Details
                </Link>
          ...
          >
            ...
            <ul className="sub-menu right ">
              <li>
                <Link
                  to="/case"
                  className={activeMenu === "/case" ? "active-menu" : ""}
                >
                  Case Study
                </Link>
              </li>
              <li>
                <Link
                  ...
                  className={
                    activeMenu === "/case-details" ? "active-menu" : ""
                  }
                >
                  Case Details
                </Link>
          ...
          <li>
            <Link
              to="/error"
              className={activeMenu === "/error" ? "active-menu" : ""}
            >
              Page Not Found
            </Link>
          </li>
        ...
        <ul className="sub-menu">
          ...
          <li>
            <Link
              ...
              className={activeMenu === "/blog-standard" ? "active-menu" : ""}
            >
              Blog Standard
            </Link>
          </li>
