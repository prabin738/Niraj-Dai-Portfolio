...
import aboutPart2 from '../../assets/images/service/service-19.jpg';
...
const ServiceDetailsContentSix = () => {
    return (
        <React.Fragment>
            <>
            {/* service-details */}
                ...
                <div className="row clearfix">
                    ...
                    <div className="service-sidebar mr_40">
                        ...
                        <ul className="category-list clearfix">
                            <li><Link to="/service/service-details">Personal Protection</Link>
                            </li>
                            <li>
                            ...
                            <li>
                            <Link to="/service/service-details-4">CCTV Security</Link>
                            </li>
                            <li>
                            <Link to="/service/service-details-5">Security Consulting</Link>
                            </li>
                            <li>
                            <Link to="/service/service-details-6" className="current">Assets Investigation</Link>
                            </li>
                        </ul>
                        </div>
...
export default ServiceDetailsContentSix;